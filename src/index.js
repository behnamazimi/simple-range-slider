...
export default function SimpleRangeSlider(wrapper, options) {
...
SimpleRangeSlider.prototype.initListeners = function () {
    ...
    let draggingStart = function (e) {
        ...
        this.slider.parentElement.addEventListener("mousemove", onDragging);
        this.slider.parentElement.addEventListener("touchmove", onDragging);
    }.bind(this);
    ...
    let draggingStop = function (e) {
        ...
        this.slider.parentElement.removeEventListener("mousemove", onDragging);
        this.slider.parentElement.removeEventListener("touchmove", onDragging);
